...
export default function FloatingContactButtons() {
  ...
  return (
    <>
     ...
     <div className="group fixed bottom-6 left-4 z-50 hidden md:block">
        {/* Waves */}
        ...
        <span className="absolute inset-0 rounded-full bg-green-500/15 animate-[ping_2.8s_ease-in-out_infinite] [animation-delay:1.8s] group-hover:animate-none" />

        <motion.a
          href="whatsapp://send?phone=+917558652253"
          className="relative flex items-center justify-center h-14 w-14 md:h-16 md:w-16 rounded-full bg-green-500 text-white shadow-lg"
          aria-label="Call Us"
      ...
      {/* Call Button (Right) */}
      <div className="group fixed bottom-6 right-4 z-50 hidden md:block">
        {/* Waves */}
